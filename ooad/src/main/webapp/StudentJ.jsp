<%-- 
    Document   : StudentJ
    Created on : Jul 21, 2019, 1:02:38 PM
    Author     : dell
--%>
...
<html>
    ...
    try {
             ...
             q="insert into student(sname,gen,email,cont,city,addr,dob,age,ssc,hsc,deg,strem,user,pass) values('"+ sname +"','"+ gen +"','"+ email +"','"+ contact +"','"+ city +"','"+ addr +"','"+ dob +"','"+ age +"','"+ ssc +"','"+ hsc +"','"+ deg +"','"+ strem +"','"+ user +"','"+ pass +"')";
