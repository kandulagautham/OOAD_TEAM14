<%-- 
    ...
    Created on : Jul 18, 2019, 3:31:46 PM
    Author     : dell
--%>
                ...
                <div class="col-lg-9">
                   ...
                   <form action="CompanyJ.jsp">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="c_name" placeholder="Enter Company Name" />
                    </div>
                     <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="hr_name" placeholder="Enter HR Name" />
                    </div>
                       <div class="form-group">
